...
public class MainFx extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		FXMLLoader fxmlLoaderLoginUI = new FXMLLoader(getClass().getResource("Login.fxml"));
		...
		FXMLLoader fxmlLoaderRegistration = new FXMLLoader(getClass().getResource("RegistrationUI.fxml"));
		...
		FXMLLoader fxmlLoaderHomepage = new FXMLLoader(getClass().getResource("Homepage.fxml"));
		...
		FXMLLoader fxmlLoaderContactUsPage = new FXMLLoader(getClass().getResource("ContactUsPage.fxml"));
		...
		FXMLLoader fxmlLoaderPastAppointments = new FXMLLoader(getClass().getResource("PastAppointments.fxml"));
